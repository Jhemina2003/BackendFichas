<template>
  <div class="generar-ticket-view">
    ...
    <main class="ticket-main" v-if="sistemaActivo">
      <GenerarTicketActions />
    </main>

    <main class="ticket-main" v-else>
...
import GenerarTicketActions from '../components/usuario/GenerarTicket/GenerarTicketActions.vue'
...
// CORREGIDO: Usar checkSystemState en lugar de checkSystemStatus
onMounted(() => {
...
.ticket-main {
  ...
  margin: 0;
  min-height: 0;
  background-color: white; /* ensure the body area for the 4 buttons is white */
}
